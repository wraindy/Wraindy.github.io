...
[![Version](https://img.shields.io/badge/version-4.0.1-gold)](https://github.com/wraindy/Wraindy.github.io)
...
- **v4.0.1** *(2025-06-26)*
  - 🐛 **关键修复**: 双击图片总是打开第一张的问题
  - 🐛 **关键修复**: 详情页EXIF数据显示为unknown的问题
  - ✨ 改进双击事件处理机制，实时获取当前图片信息
  - ✨ 增强数据验证逻辑，正确处理"Unknown"字符串
  - 🔧 优化错误处理和边界条件检查
  - 📝 添加详细的Bug修复记录文档
